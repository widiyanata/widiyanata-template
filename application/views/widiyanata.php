...
<body>
	...
	<div class="loader">
		<div class="wrap">
			<img src="assets/img/three-dots.svg" alt="pre loader">
			<p>please wait</p>
			<p>Widiyanata is processing your request....</p>
		</div>
	</div>

	<a href="#" class="main-trigger"> <i class="fa fa-5x fa-bars"></i><span>menu</span></a>
	...
	<div class="social">
		<a href="https://www.facebook.com/widdynata.eemsatu" class="btn button-custom btn-custom-one"><i class="fa fa-facebook "></i></a>
		...
		<div id="bl-main" class="bl-main">
			<section id="about">
				...
				<div class="bl-content">
					<div class="img">
						<img src="assets/img/hireme_author_img.jpg" alt="About me">
					</div>
					<div class="desc">
			...
			<section id="bl-work-section">
				<div class="bl-box">
					<h2 class="bl-icon bl-icon-works">Project</h2>
				</div>
				<div class="bl-content work">
					<!-- intro -->
					...
					<div class="cd-projects-wrapper">
						<ul class="cd-slider">
							<li class="current">
								<a href="#" data-type="project-1">
									<img src="assets/img/thumb/portographer.jpg" alt="Full Intro">
									<div class="project-info">
										<h2>Website Template - portographer</h2>
									</div>
								</a>
							</li>
							<li>
								<a href="#" data-type="project-2">
									<img src="assets/img/thumb/content-marketing-blogging.png" alt="project image">
									<div class="project-info">
										<h2>PHP - <br>Simple MVC blogging system</h2>
									</div>
								</a>
							</li>
							<li>
								<a href="#" data-type="project-3">
									<img src="assets/img/thumb/programmer.jpg" alt="project image">
									<div class="project-info">
										<h2>Website template - programmer</h2>
									</div>
								</a>
							</li>
						</ul>
					...
					<div class="cd-project-content project-1">
						<div>
							<div class="">
								<div>
									<img src="assets/img/portographer.png" alt="">
								</div>
								<h2>Website Template - portographer</h2>
								<em>Valid HTML5 web template</em>
								<a class="btn demo" href="http://widiyanata.com/demo/portographer/">demo</a>
							</div>
						</div>
					...
					<div class="cd-project-content project-2">
						<div>
							<div class="">
								<div>
									<img src="assets/img/thumb/content-marketing-blogging.png" alt="">
								</div>
								<h2>PHP - Simple MVC blog</h2>
								<em>PHP basic blogging system using MVC patern</em>
								<a class="btn demo" href="http://widiyanata.com/project/mvc-blog/">demo</a>
							</div>
						</div>
						<a href="#0" class="close cd-img-replace">Close</a>
					</div>
					...
					<div class="cd-project-content project-3">
						<div>
							<div class="">
								...
								<h2>Website Template - photography</h2>
								<em>HTML5 template for photography</em>
								<p>This template is from tympanus, and I just make a litle customization.</p>
								<a class="btn demo" href="http://widiyanata.com/project/photography/">demo</a>
							</div>
						</div>
						<a href="#0" class="close cd-img-replace">Close</a>
					</div>
			...
			<section id="services">
				<div class="bl-box">
					<h2 class="bl-icon bl-icon-blog">Service</h2>
				</div>
